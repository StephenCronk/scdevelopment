...
${e.getProgramInfoLog(l)??"(no log)"}`);e.deleteShader(i),e.deleteShader(r),h=l}catch(i){return console.error("[gl]",i),null}const L=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,L),e.bufferData(e.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),e.STATIC_DRAW),e.enableVertexAttribArray(0),e.vertexAttribPointer(0,2,e.FLOAT,!1,0,0),e.useProgram(h);const w={resolution:e.getUniformLocation(h,"uResolution"),time:e.getUniformLocation(h,"uTime"),pointer:e.getUniformLocation(h,"uPointer"),pointerActive:e.getUniformLocation(h,"uPointerActive"),press:e.getUniformLocation(h,"uPress"),event:e.getUniformLocation(h,"uEvent"),focus:e.getUniformLocation(h,"uFocus"),paper:e.getUniformLocation(h,"uPaper"),dark:e.getUniformLocation(h,"uDark"),balls:e.getUniformLocation(h,"uBalls"),partA:e.getUniformLocation(h,"uPartA"),partB:e.getUniformLocation(h,"uPartB"),partC:e.getUniformLocation(h,"uPartC"),partSqY:e.getUniformLocation(h,"uPartSqY"),shapeMix:e.getUniformLocation(h,"uShapeMix"),shapeK:e.getUniformLocation(h,"uShapeK"),shapeSpin:e.getUniformLocation(h,"uShapeSpin"),wobble:e.getUniformLocation(h,"uWobble")},x=ce(a.paperLight),m=ce(a.paperDark);let d=Y,c=0,y=0;function S(){const i=Math.min(window.devicePixelRatio||1,f.maxDpr),r=Math.max(1,Math.round(t.clientWidth*i*d)),l=Math.max(1,Math.round(t.clientHeight*i*d));r===c&&l===y||(c=r,y=l,t.width=r,t.height=l,e.viewport(0,0,r,l),e.uniform2f(w.resolution,r,l))}let _=16,B=0;function me(i){_+=(i-_)*.08,B++,!(B<45)&&(_>20&&d>ie?(d=Math.max(ie,d-.12),B=0,S()):_<12&&d<Y&&(d=Math.min(Y,d+.08),B=0,S()))}let z=0,I=!1,K=0,N=0;const F=new Float32Array(f.balls*4);function ge(i){for(let r=0;r<f.balls;r++){const l=r*2.3999632;let R=Math.sin(i*(.53+.11*r)+l)+1e-4,P=Math.cos(i*(.47+.09*r)+l*1.7)+1e-4,C=Math.sin(i*(.41+.13*r)+l*2.3)+1e-4;const q=Math.hypot(R,P,C),W=(.45+.25*(r*.6180339%1))*(.88+.12*Math.sin(i*.6+l))/q;F[r*4]=R*W,F[r*4+1]=P*W,F[r*4+2]=C*W,F[r*4+3]=.26+.12*(r*.381966%1)}e.uniform4fv(w.balls,F)}const ve=Te();function M(i){const r=o();ge(i);const l=ve(i);e.uniform4fv(w.partA,l.partA),e.uniform4fv(w.partB,l.partB),e.uniform4fv(w.partC,l.partC),e.uniform1fv(w.partSqY,l.partSqY),e.uniform1f(w.shapeMix,l.mix),e.uniform1f(w.shapeK,l.k),e.uniform1f(w.shapeSpin,l.spin),e.uniform1f(w.wobble,l.wobble),e.uniform1f(w.time,i),e.uniform2f(w.pointer,r.pointer[0],r.pointer[1]),e.uniform1f(w.pointerActive,r.pointerActive),e.uniform1f(w.press,r.press),e.uniform1f(w.event,r.eventTime),e.uniform1f(w.focus,r.focus),e.uniform1f(w.dark,r.dark),e.uniform3f(w.paper,x[0]+(m[0]-x[0])*r.dark,x[1]+(m[1]-x[1])*r.dark,x[2]+(m[2]-x[2])*r.dark),e.drawArrays(e.TRIANGLES,0,3)}function X(i){if(!I)return;const r=N===0?16:i-N,l=Math.min(r,50);N=i,K+=l/1e3,S(),r<100&&me(l),M(K),z=requestAnimationFrame(X)}function V(i,r){c=i,y=r,t.width=i,t.height=r,e.viewport(0,0,i,r),e.uniform2f(w.resolution,i,r)}function Z(){S(),M(le)}const Q=()=>{I?S():Z()};window.addEventListener("resize",Q);const J=()=>{document.hidden?j():a.reducedMotion||te()};document.addEventListener("visibilitychange",J);const ee=i=>{i.preventDefault(),I=!1,cancelAnimationFrame(z),t.dispatchEvent(new CustomEvent("gl:lost",{bubbles:!0}))};t.addEventListener("webglcontextlost",ee);function te(){if(!I){if(a.reducedMotion){Z();return}I=!0,N=0,_=16,B=0,z=requestAnimationFrame(X)}}function j(){I=!1,cancelAnimationFrame(z)}return{mode:n,start:te,stop:j,capture(i={}){const{w:r,h:l,type:R="image/png",quality:P,t:C=le}=i;r&&l?V(r,l):S(),M(C);const q=t.toDataURL(R,P);return r&&l&&(c=0),q},bench(i=60,r,l){r&&l?V(r,l):S();const R=new Uint8Array(4),P=()=>e.readPixels(0,0,1,1,e.RGBA,e.UNSIGNED_BYTE,R);M(0),P();const C=performance.now();for(let U=0;U<i;U++)M(U*.016);P();const q=+((performance.now()-C)/i).toFixed(2);return c=0,{msPerFrame:q,buffer:`${r??t.width}x${l??t.height}`}},dispose(){j(),window.removeEventListener("resize",Q),document.removeEventListener("visibilitychange",J),t.removeEventListener("webglcontextlost",ee),e.deleteProgram(h),e.deleteBuffer(L)}}}const ue=78,pe=11.5,Oe=3.2,Be=9;function Fe(t){let o=0,a=0,u=0,n=0,e=0,g=0,f=0,v=0,p=0,b=0,s=0;function h(c,y){const S=t.getBoundingClientRect();S.width===0||S.height===0||(o=((c-S.left)/S.width*2-1)*(S.width/S.height),a=-((y-S.top)/S.height*2-1))}const L=c=>{h(c.clientX,c.clientY),f=1},w=()=>{f=1},x=()=>{f=0,p=0},m=c=>{h(c.clientX,c.clientY),f=1,p=1},d=()=>{p=0};return window.addEventListener("pointermove",L,{passive:!0}),window.addEventListener("pointerdown",m,{passive:!0}),window.addEventListener("pointerup",d,{passive:!0}),window.addEventListener("pointercancel",x,{passive:!0}),document.addEventListener("pointerenter",w,{passive:!0}),document.addEventListener("pointerleave",x,{passive:!0}),{get position(){return[u,n]},get active(){return v},get press(){return b},sample(){const c=performance.now(),y=s===0?1/60:Math.min((c-s)/1e3,1/30);s=c,e+=((o-u)*ue-e*pe)*y,g+=((a-n)*ue-g*pe)*y,u+=e*y,n+=g*y,v+=(f-v)*Math.min(1,Oe*y),b+=(p-b)*Math.min(1,Be*y)},dispose(){window.removeEventListener("pointermove",L),window.removeEventListener("pointerdown",m),window.removeEventListener("pointerup",d),window.removeEventListener("pointercancel",x),document.removeEventListener("pointerenter",w),document.removeEventListener("pointerleave",x)}}}const Me=/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/;function A(t){const o=document.getElementById(t);if(!o)throw new Error(`missing element #${t}`);return o}function qe({onSuccess:t,onToggle:o,announce:a}){const u=document.querySelector(".page"),n=A("js-disclose"),e=A("js-panel"),g=A("js-form"),f=A("js-submit"),v=A("js-note"),p=[{input:A("f-name"),err:A("f-name-err"),label:"name"},{input:A("f-email"),err:A("f-email-err"),label:"email"},{input:A("f-message"),err:A("f-message-err"),label:"message"}],b=A("f-gotcha");let s=!1;const h=(d,c)=>{s=d,n.setAttribute("aria-expanded",String(s)),e.classList.toggle("is-open",s),u.classList.toggle("is-expanded",s),document.body.classList.toggle("form-open",s),e.inert=!s,n.querySelector(".disclose-text").textContent=s?"or just email me":"or send a message",n.setAttribute("aria-label",s?"Hide the contact form":"Show the contact form"),o(s),s&&c&&requestAnimationFrame(()=>p[0].input.focus({preventScroll:!0}))};h(!1,!1),n.addEventListener("click",()=>h(!s,!0));function L(d,c){const y=p[d];y.input.closest(".field").classList.toggle("is-invalid",c!==null),y.input.setAttribute("aria-invalid",String(c!==null)),y.err.textContent=c??"",y.err.hidden=c===null,c?y.input.setAttribute("aria-describedby",y.err.id):y.input.removeAttribute("aria-describedby")}function w(){let d=!0;const[c,y,S]=[p[0].input.value.trim(),p[1].input.value.trim(),p[2].input.value.trim()];return c.length<1?(L(0,"Please add your name."),d=!1):L(0,null),y.length<1?(L(1,"Please add an email address."),d=!1):Me.test(y)?L(1,null):(L(1,"That doesn't look like an email address."),d=!1),S.length<2?(L(2,"Please add a message."),d=!1):L(2,null),d}p.forEach((d,c)=>{d.input.addEventListener("input",()=>{d.input.closest(".field").classList.contains("is-invalid")&&L(c,null)})});let x=!1;function m(d,c){v.textContent=d,v.classList.toggle("is-error",c),d&&a(d)}g.addEventListener("submit",async d=>{if(d.preventDefault(),!x){if(b.value.trim()!==""){g.reset(),m("Thanks — message sent.",!1);return}if(!w()){const c=p.filter(y=>y.input.closest(".field").classList.contains("is-invalid"));c[0]?.input.focus(),a(c.length===1?"One field needs attention.":`${c.length} fields need attention.`),v.textContent="",v.classList.remove("is-error");return}x=!0,f.disabled=!0,f.setAttribute("aria-busy","true"),m("Sending…",!1);try{const c=await fetch(be,{method:"POST",headers:{Accept:"application/json"},body:new FormData(g)});if(c.ok)g.reset(),p.forEach((y,S)=>L(S,null)),m("Thanks — message sent. I’ll come back to you shortly.",!1),t();else{const y=await c.json().catch(()=>null),S=y?.errors?.[0]?.message,_=y?.error;S?m(S,!0):(console.error(`[contact] Formspree ${c.status}: ${_??"(no detail)"}`),m(`Couldn’t send that — please email me at ${D.email} instead.`,!0))}}catch{m(`Couldn’t reach the server — please email me at ${D.email} instead.`,!0)}finally{x=!1,f.disabled=!1,f.removeAttribute("aria-busy")}}})}function ze(t,o){const a=document.getElementById("js-copy"),u=document.getElementById("js-copy-label");if(!a||!u)return;if(!navigator.clipboard){a.remove();return}a.setAttribute("aria-label",`Copy ${t} to clipboard`);let n=0;a.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t),u.textContent="Copied",a.classList.add("is-done"),o("Email address copied to clipboard"),clearTimeout(n),n=window.setTimeout(()=>{u.textContent="Copy",a.classList.remove("is-done")},2e3)}catch{u.textContent="Press ⌘C",clearTimeout(n),n=window.setTimeout(()=>{u.textContent="Copy"},2500)}})}const fe="theme";function Ne(){try{const t=localStorage.getItem(fe);return t==="light"||t==="dark"?t:null}catch{return null}}function Ue(t){try{localStorage.setItem(fe,t)}catch{}}function Ge(t){let o=Ne()??"dark",a=o==="dark"?1:0;const u=document.getElementById("js-theme"),n=document.getElementById("js-theme-label");function e(g,f){o=g,document.documentElement.dataset.theme=o,document.documentElement.style.colorScheme=o;const v=o==="dark"?"light":"dark";n&&(n.textContent=v==="dark"?"Dark":"Light"),u?.setAttribute("aria-label",`Switch to ${v} mode`),u?.setAttribute("aria-pressed",String(o==="dark")),f&&t(`${o==="dark"?"Dark":"Light"} mode`)}return e(o,!1),u?.addEventListener("click",()=>{const g=o==="dark"?"light":"dark";e(g,!0),Ue(g)}),{amount(g){return a+=((o==="dark"?1:0)-a)*Math.min(1,4*g),a},get target(){return o}}}const G=document.getElementById("stage"),k=document.getElementById("poster"),je=document.getElementById("js-status"),H=t=>{je.textContent=t};function We(){document.getElementById("js-name").textContent=D.name,document.getElementById("js-role").textContent=D.role;const t=document.getElementById("js-email");t.textContent=D.email,t.href=`mailto:${D.email}`;const o=document.getElementById("js-availability");o.textContent=D.availability,document.getElementById("js-github").remove(),document.title=`${D.name} — ${D.role}`}function $(){if(G.hidden=!0,k.hidden=!1,k.addEventListener("load",()=>k.classList.add("is-shown"),{once:!0}),k.addEventListener("error",()=>{k.hidden=!0},{once:!0}),k.getAttribute("src"))k.complete&&k.naturalWidth>0&&k.classList.add("is-shown");else{const t=document.documentElement.dataset.theme!=="light";k.src=(t?k.dataset.srcDark:k.dataset.srcLight)??""}}function Ye(){We();const t=Ge(H),o=new URLSearchParams(location.search),a=o.has("static"),u=window.matchMedia("(prefers-reduced-motion: reduce)").matches||o.has("reduced");let n=-1;const e=()=>{n=performance.now()};let g=0,f=0,v=0;if(ze(D.email,H),qe({onSuccess:e,onToggle:h=>{g=h?1:0},announce:H}),a){$();return}const p=Fe(G),s=Ce(G,()=>{p.sample();const h=performance.now(),L=v===0?1/60:Math.min((h-v)/1e3,1/30);return v=h,f+=(g-f)*Math.min(1,4.5*L),{pointer:p.position,pointerActive:p.active,press:p.press,eventTime:n<0?999:(h-n)/1e3,focus:f,dark:t.amount(L)}},{paperLight:ne.paperLight,paperDark:ne.paperDark,reducedMotion:u,forceGL1:o.has("gl1")});if(!s){p.dispose(),$();return}G.addEventListener("gl:lost",()=>{console.warn("[gl] context lost — falling back to the still poster"),$()}),s.start()}Ye();
